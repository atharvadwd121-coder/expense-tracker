...
## Dependencies.
You will need Python 3.x set up on your computer to run this project.
The only extra library required is for making those graphs.
It is **matplotlib**.
...
Run this command to get matplotlib installed.
